class ScoreBox extends Phaser.GameObjects.Container
{
    constructor(config)
    {
        ...
        this.counter = 0;
        this.moneyBar = this.scene.add.image(120, 50, 'money_container');
        this.moneyBar.setScale(1.5, 1);

        this.moneySign1 = this.scene.add.image(90, 85, 'money_sign');
        this.moneySign2 = this.scene.add.image(140, 85, 'money_sign');
        this.moneySign3 = this.scene.add.image(190, 85, 'money_sign');
    ...
    scoreUpdated()
    {
        ...
        else if(model.score >= 60 || model.score >= 0)
        {
            for (var i = 0; i < this.moneyBlocks.length; i++)
            {
                switch(i)
